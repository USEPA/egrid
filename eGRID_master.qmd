...
```{r}
#| echo: false
#| label: print_epa_tab_facilities
table_facilities
```
...
```{r}
#| echo: false
#| label: print_epa_tab_emissions_ozone
...
```{r}
#| echo: false
#| label: create_epa_summary_table
