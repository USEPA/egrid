...
The demographic file uses geographic coordinates from all plants and EPA's EJScreen tool to calculate the demographic characteristics of surrounding neighborhoods. For more information on the analysis process, [view EJScreen's methodology](https://www.epa.gov/ejscreen/technical-information-and-data-downloads).
...
<!-- #| label: metric_conversion -->

<!-- #| file: "scripts/metric_file.R" -->
...
<!-- #| label: metric_final_formatting -->

<!-- #| file: "scripts/metric_final_formatting.R" -->
