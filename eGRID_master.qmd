...
@tbl-unzipped-eia shows each of the unzipped raw files across the three EIA forms, including the sheets embedded within.

<!--# Would be nice to highlight the sheets that will actually be used in eGRID productions... -->

```{r}
#| label: tbl-unzipped-eia
#| tbl-cap: List of Unzipped EIA Form files and Sheets
#| tbl-subcap: ["EIA-923", "EIA-860", "EIA-861"]
#| layout-ncol: 3
#| message: FALSE
#| warning: FALSE
...
make_sheets_table <- function(sheets, form){
 ...
 make_sheets_table(sheets_923, "923")
 make_sheets_table(sheets_860, "860")
 make_sheets_table(sheets_861, "861")
