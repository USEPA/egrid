...
generator_file <- readr::read_rds(
           glue::glue("data/1_production_model/outputs/{params$eGRID_year}/generator_file.RDS"))
```
...
unit_file <- readr::read_rds(
           glue::glue("data/1_production_model/outputs/{params$eGRID_year}/unit_file.RDS"))
```
...
plant_file <- readr::read_rds(
           glue::glue("data/1_production_model/outputs/{params$eGRID_year}/plant_file.RDS"))
```
...
ba_agg  <- read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/ba_aggregation.RDS"))
st_agg  <- read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/state_aggregation.RDS"))
srl_agg <- read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/subregion_aggregation.RDS"))
nrl_agg <- read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/nerc_aggregation.RDS"))
us_agg  <- read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/us_aggregation.RDS"))
```
...
#| file: "scripts/1_production_model/final_formatting.R"
#| results: hold
```
...
#| file: "scripts/1_production_model/final_formatting_metric.R"
#| results: hold
```
