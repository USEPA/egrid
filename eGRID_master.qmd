...
generator_file <- readr::read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/generator_file_{params$temporal_res}.RDS"))
```
...
unit_file <- readr::read_rds(
      glue::glue("data/1_production_model/outputs/{params$eGRID_year}/unit_file_{params$temporal_res}.RDS"))
```
...
plant_file <- readr::read_rds(
        glue::glue("data/1_production_model/outputs/{params$eGRID_year}/plant_file_{params$temporal_res}.RDS"))
```
...
ba_agg  <- read_rds(
    glue::glue("data/1_production_model/outputs/{params$eGRID_year}/ba_aggregation_{params$temporal_res}.RDS"))

st_agg  <- read_rds(
    glue::glue("data/1_production_model/outputs/{params$eGRID_year}/state_aggregation_{params$temporal_res}.RDS"))

srl_agg <- read_rds(
    glue::glue("data/1_production_model/outputs/{params$eGRID_year}/subregion_aggregation_{params$temporal_res}.RDS"))

nrl_agg <- read_rds(
    glue::glue("data/1_production_model/outputs/{params$eGRID_year}/nerc_aggregation_{params$temporal_res}.RDS"))

us_agg  <- read_rds(
    glue::glue("data/1_production_model/outputs/{params$eGRID_year}/us_aggregation_{params$temporal_res}.RDS"))
```
