...
![Figure 2: eGRID architecture.](data/1_production_model/static_tables/formatting/egrid_architecture.png)
...
-   `scripts/1_production_model/`: all scripts to create the production model, including steps to download and clean data, create each data aggregation level, format final dataset, and convert to metric units.
