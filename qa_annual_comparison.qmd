...
nox_output <- 
  ...
  select(subregion, contains("nox_output_rate_2"), nox_output_rate_pct,  generation_notes)
...
plotly::ggplotly(rate_comparison, width = 700) %>%   plotly::layout(legend = list(orientation = "h", x = 0.2, y = 1.1))
...
ch4_nonbaseload <- 
  state_rate_comparison %>% select(state, contains("ch4_nonbaseload"), generation_notes)
...
n2o_nonbaseload <- 
  state_rate_comparison %>% select(state, contains("n2o_nonbaseload"), generation_notes)
...
co2e_nonbaseload <- 
  state_rate_comparison %>% select(state, contains("co2e_nonbaseload"), generation_notes)
