...
nox_output <- 
  ...
  select(subregion, contains("nox_output_rate_2"), nox_output_rate_pct,  
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
nox_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_output_rate"), coal_note)
...
nox_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_output_rate"), oil_note)
...
nox_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_output_rate"), gas_note)
...
nox_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_oz_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_oz_output_rate"), coal_note)
...
nox_oz_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_oz_output_rate"), oil_note)
...
nox_oz_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_oz_output_rate"), gas_note)
...
nox_oz_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_oz_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
so2_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_so2_output_rate"), coal_note)
...
so2_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_so2_output_rate"), oil_note)
...
so2_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_so2_output_rate"), gas_note)
...
so2_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_so2_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2_output_rate"), coal_note)
...
co2_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2_output_rate"), oil_note)
...
co2_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2_output_rate"), gas_note)
...
co2_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
ch4_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_ch4_output_rate"), coal_note)
...
ch4_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_ch4_output_rate"), oil_note)
...
ch4_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_ch4_output_rate"), gas_note)
...
ch4_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_ch4_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
n2o_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_n2o_output_rate"), coal_note)
...
n2o_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_n2o_output_rate"), oil_note)
...
n2o_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_n2o_output_rate"), gas_note)
...
n2o_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_n2o_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2e_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2e_output_rate"), coal_note)
...
co2e_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2e_output_rate"), oil_note)
...
co2e_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2e_output_rate"), gas_note)
...
co2e_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2e_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_input_rate"), coal_note)
...
nox_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_input_rate"), oil_note)
...
nox_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_input_rate"), gas_note)
...
nox_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
nox_oz_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_oz_input_rate"), coal_note)
...
nox_oz_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_oz_input_rate"), oil_note)
...
nox_oz_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_oz_input_rate"), gas_note)
...
nox_oz_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_oz_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
so2_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_so2_input_rate"), coal_note)
...
so2_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_so2_input_rate"), oil_note)
...
so2_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_so2_input_rate"), gas_note)
...
so2_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_so2_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
co2_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2_input_rate"), coal_note)
...
co2_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2_input_rate"), oil_note)
...
co2_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2_input_rate"), gas_note)
...
co2_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
ch4_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_ch4_input_rate"), coal_note)
...
ch4_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_ch4_input_rate"), oil_note)
...
ch4_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_ch4_input_rate"), gas_note)
...
ch4_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_ch4_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
n2o_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_n2o_input_rate"), coal_note)
...
n2o_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_n2o_input_rate"), oil_note)
...
n2o_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_n2o_input_rate"), gas_note)
...
n2o_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_n2o_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
co2e_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2e_input_rate"), coal_note)
...
co2e_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2e_input_rate"), oil_note)
...
co2e_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2e_input_rate"), gas_note)
...
co2e_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2e_input_rate"), coal_note,
         oil_note, gas_note, other_fossil_note)
...
nox_oz_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_oz_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
so2_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
co2_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
ch4_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("ch4_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
n2o_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
co2e_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_combustion"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
so2_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_output_rate_nonbaseload"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))%>% 
...
co2_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_output_rate_nonbaseload"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note")) %>% 
...
ch4_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("ch4_output_rate_nonbaseload"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note")) %>% 
...
n2o_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_output_rate_nonbaseload"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note")) %>% 
...
co2e_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_output_rate_nonbaseload"),
         -contains(c("coal", "oil", "gas", "fossil")), contains("note")) %>% 
...
nox_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_output_rate"), coal_note)
...
nox_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_output_rate"), oil_note)
...
nox_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_output_rate"), gas_note)
...
nox_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_oz_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_oz_output_rate"), coal_note)
...
nox_oz_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_oz_output_rate"), oil_note)
...
nox_oz_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_oz_output_rate"), gas_note)
...
nox_oz_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_oz_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
so2_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_so2_output_rate"), coal_note)
...
so2_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_so2_output_rate"), oil_note)
...
so2_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_so2_output_rate"), gas_note)
...
so2_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_so2_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2_output_rate"), coal_note)
...
co2_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2_output_rate"), oil_note)
...
co2_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2_output_rate"), gas_note)
...
co2_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
ch4_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_ch4_output_rate"), coal_note)
...
ch4_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_ch4_output_rate"), oil_note)
...
ch4_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_ch4_output_rate"), gas_note)
...
ch4_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_ch4_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
n2o_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_n2o_output_rate"), coal_note)
...
n2o_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_n2o_output_rate"), oil_note)
...
n2o_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_n2o_output_rate"), gas_note)
...
n2o_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_n2o_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2e_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2e_output_rate"), coal_note)
...
co2e_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2e_output_rate"), oil_note)
...
co2e_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2e_output_rate"), gas_note)
...
co2e_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2e_output_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_input_rate"), coal_note)
...
nox_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_input_rate"), oil_note)
...
nox_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_input_rate"), gas_note)
...
nox_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_oz_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_oz_input_rate"), coal_note)
...
nox_oz_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_oz_input_rate"), oil_note)
...
nox_oz_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_oz_input_rate"), gas_note)
...
nox_oz_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_oz_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
so2_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_so2_input_rate"), coal_note)
...
so2_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_so2_input_rate"), oil_note)
...
so2_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_so2_input_rate"), gas_note)
...
so2_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_so2_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2_input_rate"), coal_note)
...
co2_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2_input_rate"), oil_note)
...
co2_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2_input_rate"), gas_note)
...
co2_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
ch4_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_ch4_input_rate"), coal_note)
...
ch4_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_ch4_input_rate"), oil_note)
...
ch4_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_ch4_input_rate"), gas_note)
...
ch4_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_ch4_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
n2o_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_n2o_input_rate"), coal_note)
...
n2o_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_n2o_input_rate"), oil_note)
...
n2o_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_n2o_input_rate"), gas_note)
...
n2o_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_n2o_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
co2e_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2e_input_rate"), coal_note)
...
co2e_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2e_input_rate"), oil_note)
...
co2e_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2e_input_rate"), gas_note)
...
co2e_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2e_input_rate"), coal_note, 
         oil_note, gas_note, other_fossil_note)
...
nox_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("nox_combustion"), 
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
nox_oz_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_combustion"), 
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
so2_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("so2_combustion"), 
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
co2_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("co2_combustion"),  
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
ch4_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("ch4_combustion"),  
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
n2o_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_combustion"),  
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
co2e_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_combustion"), 
         -contains(c("coal", "oil", "gas", "fossil")), contains("note"))
...
nox_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("nox_output_rate_nonbaseload"),  
         -contains(c("coal", "oil", "gas", "fossil")), contains("note")) %>% 
  mutate(pct_diff = (nox_output_rate_nonbaseload_2023 -
                       nox_output_rate_nonbaseload_2022) /
           nox_output_rate_nonbaseload_2023 * 100) %>% 
...
nox_oz_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (nox_oz_output_rate_nonbaseload_2023 -
                       nox_oz_output_rate_nonbaseload_2022) /
           nox_oz_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
...
so2_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("so2_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (so2_output_rate_nonbaseload_2023 -
                       so2_output_rate_nonbaseload_2022) /
           so2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
...
co2_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("co2_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (co2_output_rate_nonbaseload_2023 -
                       co2_output_rate_nonbaseload_2022) /
           co2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
...
ch4_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("ch4_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (ch4_output_rate_nonbaseload_2023 -
                       ch4_output_rate_nonbaseload_2022) /
           ch4_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
...
n2o_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (n2o_output_rate_nonbaseload_2023 -
                       n2o_output_rate_nonbaseload_2022) /
           n2o_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
...
co2e_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_output_rate_nonbaseload"), contains("note")) %>% 
  mutate(pct_diff = (co2e_output_rate_nonbaseload_2023 -
                       co2e_output_rate_nonbaseload_2022) /
           co2e_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "coal_note")
