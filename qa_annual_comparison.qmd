...
nox_output <- 
  ...
  select(subregion, contains("nox_output_rate_2"), nox_output_rate_pct,  
         generation_notes, -contains(c("coal", "oil", "gas", "fossil")))
...
nox_oz_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_oz_output_rate_2"),
...
so2_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_output_rate_2"),
...
co2_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_output_rate_2"),
...
ch4_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("ch4_output_rate_2"),
...
n2o_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_output_rate_2"),
...
co2e_output <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_output_rate_2"),
...
nox_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_nox_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_nox_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_nox_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_nox_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_oz_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_nox_oz_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_oz_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_nox_oz_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_oz_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_nox_oz_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_oz_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_nox_oz_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_so2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_so2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_so2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_so2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_so2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_so2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_so2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_so2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_co2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_co2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_co2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_co2_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_ch4_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_ch4_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_ch4_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_ch4_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_ch4_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_ch4_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_ch4_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_ch4_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_n2o_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_n2o_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_n2o_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_n2o_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_n2o_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_n2o_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_n2o_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_n2o_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_output_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2e_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_co2e_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_output_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2e_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_co2e_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_output_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2e_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_co2e_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_output_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2e_output_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_co2e_output_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_input_rate_2"),
...
nox_oz_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_oz_input_rate_2"),
...
so2_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_input_rate_2"),
...
co2_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_input_rate_2"),
...
n2o_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_input_rate_2"),
...
co2e_input <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_input_rate_2"),
...
nox_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_nox_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_nox_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_nox_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_nox_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_nox_oz_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_nox_oz_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_nox_oz_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_nox_oz_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_nox_oz_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_nox_oz_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_nox_oz_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_nox_oz_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_so2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_so2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_so2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_so2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_so2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_so2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_so2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_so2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_co2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2_input_rate"), generation_notes)
...
co2_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_co2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_co2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_ch4_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_ch4_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_ch4_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_ch4_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_ch4_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_ch4_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_ch4_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_ch4_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_n2o_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_n2o_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_n2o_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_n2o_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_n2o_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_n2o_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_n2o_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_n2o_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_input_coal <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("coal_co2e_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = coal_co2e_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_input_oil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("oil_co2e_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = oil_co2e_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_input_gas <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("gas_co2e_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = gas_co2e_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_input_fossil <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("fossil_co2e_input_rate"), generation_notes)

rate_comparison <- ggplot(subregion_us_comparison, aes(x = subregion, 
                                                y = fossil_co2e_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_combustion"),
         generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
nox_oz_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_oz_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
so2_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
co2_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
ch4_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("ch4_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
n2o_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
co2e_combustion <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_combustion"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
nox_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (nox_output_rate_nonbaseload_2023 -
                       nox_output_rate_nonbaseload_2022) /
           nox_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = nox_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_oz_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("nox_oz_output_rate_nonbaseload"), 
         generation_notes) %>% 
  mutate(pct_diff = (nox_oz_output_rate_nonbaseload_2023 -
                       nox_oz_output_rate_nonbaseload_2022) /
           nox_oz_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion,
                                                y = nox_oz_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
so2_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("so2_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))%>% 
  mutate(pct_diff = (so2_output_rate_nonbaseload_2023 -
                       so2_output_rate_nonbaseload_2022) /
           so2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = so2_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (co2_output_rate_nonbaseload_2023 -
                       co2_output_rate_nonbaseload_2022) /
           co2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = co2_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
ch4_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("ch4_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (ch4_output_rate_nonbaseload_2023 -
                       ch4_output_rate_nonbaseload_2022) /
           ch4_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = ch4_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
n2o_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("n2o_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (n2o_output_rate_nonbaseload_2023 -
                       n2o_output_rate_nonbaseload_2022) /
           n2o_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = n2o_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2e_nonbaseload <- 
  subregion_rate_comparison %>% 
  select(subregion, contains("co2e_output_rate_nonbaseload"), generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (co2e_output_rate_nonbaseload_2023 -
                       co2e_output_rate_nonbaseload_2022) /
           co2e_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")

rate_comparison <- ggplot(subregion_comparison, aes(x = subregion, 
                                                y = co2e_output_rate_nonbaseload, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
nox_output <- 
  ...
  select(state, contains("nox_output_rate_2"), 
         nox_output_rate_pct, generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
nox_oz_output <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_output_rate_2"),
         nox_oz_output_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
so2_output <- 
  state_rate_comparison %>% 
  select(state, contains("so2_output_rate_2"),
         so2_output_rate_pct, generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
co2_output <- 
  state_rate_comparison %>% 
  select(state, contains("co2_output_rate_2"),
         co2_output_rate_pct, generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
ch4_output <- 
  state_rate_comparison %>% 
  select(state, contains("ch4_output_rate_2"),
         ch4_output_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
n2o_output <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_output_rate_2"),
         n2o_output_rate_pct, generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
co2e_output <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_output_rate_2"),
         co2e_output_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
nox_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_output_rate"), generation_notes)
...
nox_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_output_rate"), generation_notes)
...
nox_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_output_rate"), generation_notes)
...
nox_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_output_rate"), generation_notes)
...
nox_oz_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_oz_output_rate"), generation_notes)
...
nox_oz_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_oz_output_rate"), generation_notes)
...
nox_oz_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_oz_output_rate"), generation_notes)
...
nox_oz_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_oz_output_rate"), generation_notes)
...
so2_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_so2_output_rate"), generation_notes)
...
so2_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_so2_output_rate"), generation_notes)
...
so2_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_so2_output_rate"), generation_notes)
...
so2_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_so2_output_rate"), generation_notes)
...
co2_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2_output_rate"), generation_notes)
...
co2_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2_output_rate"), generation_notes)
...
co2_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2_output_rate"), generation_notes)
...
co2_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2_output_rate"), generation_notes)
...
ch4_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_ch4_output_rate"), generation_notes)
...
ch4_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_ch4_output_rate"), generation_notes)
...
ch4_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_ch4_output_rate"), generation_notes)
...
ch4_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_ch4_output_rate"), generation_notes)
...
n2o_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_n2o_output_rate"), generation_notes)
...
n2o_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_n2o_output_rate"), generation_notes)
...
n2o_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_n2o_output_rate"), generation_notes)
...
n2o_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_n2o_output_rate"), generation_notes)
...
co2e_output_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2e_output_rate"), generation_notes)
...
co2e_output_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2e_output_rate"), generation_notes)
...
co2e_output_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2e_output_rate"), generation_notes)
...
co2e_output_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2e_output_rate"), generation_notes)
...
nox_input <- 
  state_rate_comparison %>% 
  select(state, contains("nox_input_rate_2"),
         nox_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
nox_oz_input <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_input_rate_2"),
         nox_oz_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
so2_input <- 
  state_rate_comparison %>% 
  select(state, contains("so2_input_rate_2"),
         so2_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
co2_input <- 
  state_rate_comparison %>% 
  select(state, contains("co2_input_rate_2"),
         co2_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
n2o_input <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_input_rate_2"),
         n2o_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
co2e_input <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_input_rate_2"),
        co2e_input_rate_pct, generation_notes, 
        -contains(c("coal", "oil", "gas", "fossil")))
...
nox_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_input_rate"), generation_notes)
...
nox_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_input_rate"), generation_notes)
...
nox_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_input_rate"), generation_notes)
...
nox_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_input_rate"), generation_notes)
...
nox_oz_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_nox_oz_input_rate"), generation_notes)
...
nox_oz_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_nox_oz_input_rate"), generation_notes)
...
nox_oz_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_nox_oz_input_rate"), generation_notes)
...
nox_oz_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_nox_oz_input_rate"), generation_notes)
...
so2_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_so2_input_rate"), generation_notes)
...
so2_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_so2_input_rate"), generation_notes)
...
so2_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_so2_input_rate"), generation_notes)
...
so2_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_so2_input_rate"), generation_notes)
...
co2_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2_input_rate"), generation_notes)
...
co2_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2_input_rate"), generation_notes)

rate_comparison <- ggplot(state_comparison, aes(x = state, 
                                                y = oil_co2_input_rate, 
                                                fill = year)) +
                    geom_bar(stat = "identity", 
                             width = 0.75,
                             position = "dodge") +
...
co2_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2_input_rate"), generation_notes)
...
co2_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2_input_rate"), generation_notes)
...
ch4_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_ch4_input_rate"), generation_notes)
...
ch4_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_ch4_input_rate"), generation_notes)
...
ch4_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_ch4_input_rate"), generation_notes)
...
ch4_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_ch4_input_rate"), generation_notes)
...
n2o_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_n2o_input_rate"), generation_notes)
...
n2o_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_n2o_input_rate"), generation_notes)
...
n2o_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_n2o_input_rate"), generation_notes)
...
n2o_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_n2o_input_rate"), generation_notes)
...
co2e_input_coal <- 
  state_rate_comparison %>% 
  select(state, contains("coal_co2e_input_rate"), generation_notes)
...
co2e_input_oil <- 
  state_rate_comparison %>% 
  select(state, contains("oil_co2e_input_rate"), generation_notes)
...
co2e_input_gas <- 
  state_rate_comparison %>% 
  select(state, contains("gas_co2e_input_rate"), generation_notes)
...
co2e_input_fossil <- 
  state_rate_comparison %>% 
  select(state, contains("fossil_co2e_input_rate"), generation_notes)
...
nox_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("nox_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
nox_oz_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
so2_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("so2_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
co2_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("co2_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
ch4_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("ch4_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
n2o_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
co2e_combustion <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_combustion"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil")))
...
nox_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("nox_output_rate_nonbaseload"), generation_notes, 
         -contains(c("coal", "oil", "gas", "fossil"))) %>% 
  mutate(pct_diff = (nox_output_rate_nonbaseload_2023 -
                       nox_output_rate_nonbaseload_2022) /
           nox_output_rate_nonbaseload_2023 * 100) %>% 
...
nox_oz_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("nox_oz_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (nox_oz_output_rate_nonbaseload_2023 -
                       nox_oz_output_rate_nonbaseload_2022) /
           nox_oz_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
...
so2_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("so2_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (so2_output_rate_nonbaseload_2023 -
                       so2_output_rate_nonbaseload_2022) /
           so2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
...
co2_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("co2_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (co2_output_rate_nonbaseload_2023 -
                       co2_output_rate_nonbaseload_2022) /
           co2_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
...
ch4_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("ch4_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (ch4_output_rate_nonbaseload_2023 -
                       ch4_output_rate_nonbaseload_2022) /
           ch4_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
...
n2o_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("n2o_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (n2o_output_rate_nonbaseload_2023 -
                       n2o_output_rate_nonbaseload_2022) /
           n2o_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
...
co2e_nonbaseload <- 
  state_rate_comparison %>% 
  select(state, contains("co2e_output_rate_nonbaseload"), generation_notes) %>% 
  mutate(pct_diff = (co2e_output_rate_nonbaseload_2023 -
                       co2e_output_rate_nonbaseload_2022) /
           co2e_output_rate_nonbaseload_2023 * 100) %>% 
  relocate(pct_diff, .before = "generation_notes")
