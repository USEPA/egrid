...
# update plant table with BA ID and remove ba_code
plant_table_3 <- 
  plant_table_2 %>% 
...
write_csv(plant_table_5 %>% select(-nerc_id) %>% rename(any_of(plant_nonmetric)), 
