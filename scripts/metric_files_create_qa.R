...
source("scripts/functions/function_metric_conversion_qa.R")

metric_conversion("plant")
metric_conversion("unit")
metric_conversion("state")
metric_conversion("ba")
metric_conversion("subregion")
metric_conversion("nerc")
metric_conversion("us")
metric_conversion("ggl")
