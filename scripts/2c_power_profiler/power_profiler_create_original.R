...
utility_subregion_manual_updates <-
  read_csv(glue::glue("data/2c_power_profiler/inputs/{params$eGRID_year}/access/manual_updates_utility_subregion.csv"),
           col_types = "ccc") %>%
  janitor::clean_names()

# Manual predominant utility updates
predominant_utility_manual_updates <-
  read_csv(glue::glue("data/2c_power_profiler/inputs/{params$eGRID_year}/access/manual_updates_predominant_utility.csv"),
           col_types = "ccccc") %>%
  janitor::clean_names() %>%
...
primary_subregion_manual_updates <-
  read_csv(glue::glue("data/2c_power_profiler/inputs/{params$eGRID_year}/access/manual_updates_primary_subregion.csv"),
           col_types = "ccc") %>%
  janitor::clean_names()
