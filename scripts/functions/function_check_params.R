...
check_params <- function() {
  ...
  eGRID_year_inputs <- c(1996:2025)
  
  if(!(params$eGRID_year %in% eGRID_year_inputs)) {
    print("The input for params$eGRID_year is not one of the valid responses. Please input a year within the range of 1996-2025.")
