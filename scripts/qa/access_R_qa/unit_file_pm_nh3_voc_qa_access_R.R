...
unit_qa <- function(emission_type, year) {
  ...
  if(dir.exists(glue::glue("data/outputs/qa/unit_file_{emission_type}_differences"))) {
    print(glue::glue("Folder unit_file_{emission_type}_differences already exists."))
  }else{
    dir.create(glue::glue("data/outputs/qa/unit_file_{emission_type}_differences"))
  }
  
  if(dir.exists(glue::glue("data/outputs/qa/unit_file_{emission_type}_differences/{params$eGRID_year}"))) {
    print(glue::glue("Folder unit_file_{emission_type}_differences/{params$eGRID_year} already exists."))
  }else{
    dir.create(glue::glue("data/outputs/qa/unit_file_{emission_type}_differences/{params$eGRID_year}"))
  }
  
  # set directory for saving files 
  save_dir <- glue::glue("data/outputs/qa/unit_file_{emission_type}_differences/{params$eGRID_year}/")
  ...
  # Import R unit data ---------
  unit_r <- read_rds(glue::glue("data/outputs/{params$eGRID_year}/unit_file_{emission_type}.RDS"))
