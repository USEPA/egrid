...
plant_rates <- 
  ...
  select(plant_id, plant_name, primary_fuel_type, heat_input, heat_input_oz, generation_ann, generation_oz, nox_mass, nox_oz_mass, so2_mass, co2_mass, ch4_mass,
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, nox_output_rate_zscore, nox_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               arrange(desc(nox_oz_output_rate_zscore)) %>% select(plant_id, plant_name, primary_fuel_type, nox_oz_output_rate_zscore, nox_oz_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, so2_output_rate_zscore, so2_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, co2_output_rate_zscore, co2_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, n2o_output_rate_zscore, n2o_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, co2e_output_rate_zscore, co2e_output_rate))
