...
knitr::kable(plant_zscore %>%
               ...
               arrange(desc(nox_in_emission_rate_zscore)) %>% select(plant_id, plant_name, primary_fuel_type, nox_in_emission_rate_zscore, nox_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, nox_oz_in_emission_rate_zscore, nox_oz_in_emission_rate))
```
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, so2_in_emission_rate_zscore, so2_in_emission_rate))
```
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, co2_in_emission_rate_zscore, co2_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, ch4_in_emission_rate_zscore, ch4_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, n2o_in_emission_rate_zscore, n2o_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, co2e_in_emission_rate_zscore, co2e_in_emission_rate))
