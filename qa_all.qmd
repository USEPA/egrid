...
eia_923 <- read_rds("data/clean_data/eia_923_clean.RDS") # change data source
...
Load generator file. Currently using published data from eGRID 2021.
...
knitr::kable(head(plant_file %>% arrange(desc(plnoxra)) %>% select(plant_id, plant_name, plnoxra), n = 20))
...
knitr::kable(head(plant_file %>% arrange(desc(plnoxro)) %>% select(plant_id, plant_name, plnoxro), n = 20))
...
knitr::kable(head(plant_file %>% arrange(desc(plso2ra)) %>% select(plant_id, plant_name, plso2ra), n = 20))
...
knitr::kable(head(plant_file %>% arrange(desc(plco2ra)) %>% select(plant_id, plant_name, plco2ra), n = 20))
...
knitr::kable(head(plant_file %>% arrange(desc(plch4ra)) %>% select(plant_id, plant_name, plch4ra), n = 20))
...
knitr::kable(head(plant_file %>% arrange(desc(pln2ora)) %>% select(plant_id, plant_name, pln2ora), n = 20))
...
```{r}
#| label: plant_co2e_outliers
#| echo: false
#| warning: false

knitr::kable(head(plant_file %>% arrange(desc(plc2era)) %>% select(plant_id, plant_name, plc2era), n = 20))
