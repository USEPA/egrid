...
knitr::kable(plant_zscore %>%
               ...
               arrange(desc(nox_in_emission_rate_zscore)) %>% select(plant_id, plant_name, primary_fuel_type, heat_input, nox_mass, nox_in_emission_rate_zscore, nox_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input_oz, nox_oz_mass, nox_oz_in_emission_rate_zscore, nox_oz_in_emission_rate))
```
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input, so2_mass, so2_in_emission_rate_zscore, so2_in_emission_rate))
```
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input, co2_mass, co2_in_emission_rate_zscore, co2_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input, ch4_mass, ch4_in_emission_rate_zscore, ch4_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input, n2o_mass, n2o_in_emission_rate_zscore, n2o_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, heat_input, co2e_mass, co2e_in_emission_rate_zscore, co2e_in_emission_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, generation_ann, nox_mass, capfac, nox_output_rate_zscore, nox_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               arrange(desc(nox_oz_output_rate_zscore)) %>% select(plant_id, plant_name, primary_fuel_type, generation_oz, nox_oz_mass, capfac, nox_oz_output_rate_zscore, nox_oz_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, generation_ann, so2_mass, capfac, so2_output_rate_zscore, so2_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, generation_ann, co2_mass, capfac, co2_output_rate_zscore, co2_output_rate))
...
knitr::kable(plant_zscore %>% 
               filter(so2_output_rate_zscore > 3 | so2_output_rate_zscore < -3) %>% 
               arrange(desc(so2_output_rate_zscore)) %>% 
               select(plant_id, plant_name, primary_fuel_type, generation_ann, ch4_mass, capfac, so2_output_rate_zscore, so2_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, generation_ann, n2o_mass, capfac, n2o_output_rate_zscore, n2o_output_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, primary_fuel_type, generation_ann, co2e_mass, capfac, co2e_output_rate_zscore, co2e_output_rate))
