...
<<<<<<< HEAD
               select(plant_name, plant_id, unit_id, primary_fuel_type, heat_input))
=======
...
if (params$temporal_res == "annual") { 
  ...
  knitr::kable(check_unit_blanks %>% 
                 select(month, plant_name, plant_id, unit_id, primary_fuel_type, prime_mover, heat_input, nox_mass, so2_mass, co2_mass))}
=======
...
if (params$temporal_res == "annual") { 
  plant_rates <- 
    ...
    select(plant_id, plant_name, heat_input, heat_input_oz, generation, generation_oz, 
           nox_mass, nox_oz_mass, so2_mass, co2_mass, ch4_mass,
  ...
  plant_rates <- 
    plant_file %>% 
    #select(plant_id, net_gen, heat_input, heat_input_oz, contains("rate")) # filter this way if using R plant file output
    select(all_of(temporal_res_cols), plant_id, plant_name, heat_input, generation, 
           nox_mass, so2_mass, co2_mass, ch4_mass,
           n2o_mass, co2e_mass, contains("ra"), contains("ro")) %>% 
    mutate(nox_output_rate = nox_mass / generation * 2000, 
           so2_output_rate = so2_mass / generation * 2000, 
           co2_output_rate = co2_mass/ generation * 2000, 
...
<<<<<<< HEAD
               ...
               select(all_of(temporal_res_cols), plant_id, plant_name, nox_input_rate_zscore, nox_input_rate))
=======
...
<<<<<<< HEAD
               ...
               select(all_of(temporal_res_cols), plant_id, plant_name, so2_input_rate_zscore, so2_input_rate))
=======
...
<<<<<<< HEAD
               ...
               select(plant_id, plant_name, co2_input_rate_zscore, co2_input_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, ch4_input_rate_zscore, ch4_input_rate))
...
knitr::kable(plant_zscore %>% 
               ...
               select(plant_id, plant_name, n2o_input_rate_zscore, n2o_input_rate))
...
<<<<<<< HEAD
               ...
               select(plant_id, plant_name, co2e_input_rate_zscore, co2e_input_rate))
=======
