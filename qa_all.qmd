...
The capacity factor must be less than 1. Check if htere are any instances of a capacity factor greater than 1.
...
ifelse(nrow(check_subregion_mix) == 0, "All state resource mixes add to 100%.", 
        glue::glue("{nrow(check_state_mix)} state resource mixes do not add to 100%."))
